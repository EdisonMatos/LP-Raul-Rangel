  ...
  texts: {
    ...
    hero: {
      ...
      obsHero: {
        ...
        text: "Atendimento preferencialmente presencial",
      },
      ctaButtonAriaLabel:
    ...
    features: {
      ...
      card1: {
        ...
        subtitle: "Defesa em processos criminais e questões relacionadas.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card4: {
        ...
        subtitle: "Consultoria sobre questões públicas e administrativas.",
        description: (
          <div>
            A_Definir
            <br />
    ...
    about: {
      ...
      paragraph: (
        <div>
          ...
          <br />
          Sua atuação abrange diversas áreas do Direito, com especial destaque
          para o Direito Público, Administrativo, Cível, Trabalhista,
          Empresarial, Criminal, Família e Tributário.
        </div>
      ),
      ...
      modal: (
        <p>
          ...
          <br />
          <br />
          Também exerceu funções importantes na Procuradoria dos municípios de
          Matinhos e Santo Antônio do Caiuá, conduzindo ações de relevância no
